...
'''
Keyword extraction Option 2 - utilization of Keybert. This approach has not been tested with a local LLM, but has been tested with transformers from hugging face. When tested, can often run slower.
